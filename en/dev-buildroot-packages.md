...
| ingenic_patcher 0.1                         |                         |                         |                         |                         |                         |
| ipctool (git)                               |                         |                         |                         |                         |                         |
| json-c-openipc 0.15-20200726                | json-c 0.15             | json-c 0.15             | json-c 0.16             | json-c 0.16             | json-c 0.16             |
| jsonfilter (git)                            |                         |                         |                         |                         |                         |
...
| libsrtp-openipc (git)                       |                         |                         |                         | libsrtp 2.4.2           | libsrtp 2.4.2           |
...
| vtund-openipc 3.0.2                         |                         |                         |                         |                         |                         |
| wifibroadcast (git)                         |                         |                         |                         |                         |                         |
| wireguard-linux-compat-openipc 1.0.20220627 |                         |                         |                         |                         |                         |
| wireguard-openipc                           |                         |                         |                         |                         |                         |
